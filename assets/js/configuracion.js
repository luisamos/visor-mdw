...
export const centroide3857 = [-8009512.641541751, -1520541.7489204113],
    ...
    colores = [
        { id: 'provincias', texto: '<div class="legend-item"><i style="background:#26a69a;"></i> Provincias</div>' },
        { id: 'distritos', texto: '<div class="legend-item"><i style="background:#26a69a;"></i> Distritos</div>' },
        { id: 'sectores', texto: '<div class="legend-item"><i style="background:#9900cc;"></i> Sectores</div>' },
        { id: 'manzanas', texto: '<div class="legend-item"><i style="background:#00ffff;"></i> Manzanas</div>' },
        {
            id: 'lotes', texto: `<div class="legend-item"><strong>Lotes</strong></div>
        ...
        { id: 'habilitacionesUrbanas', texto: '<div class="legend-item"><i style="background:#0000ff"></i> Habilitaciones Urbanas</div>' },
        {
            id: 'serviciosBasicos', texto: `<div class="legend-item"><strong>Servicios básicos</strong></div>
        ...
        <div class="legend-item"></div>`},
        {
            id: 'clasificacionPredios', texto: `<div class="legend-item"><strong>Clasificación de Predios</strong></div>
        ...
        <div class="legend-item"></div>`},
        {
            id: 'tiposPersonas', texto: `<div class="legend-item"><strong>Tipos de personas</strong></div>
            ...
            <div class="legend-item"></div>`},
        {
            id: 'puertas', texto: `<div class="legend-item"><strong>Puertas</strong></div>
                ...
                <div class="legend-item"></div>`},
        { id: 'areasInvadidas', texto: '<div class="legend-item"><i style="background:#f44336"></i> Áreas invadidas</div>' },
        { id: 'parques', texto: '<div class="legend-item"><i style="background:#073763"></i> Parques</div>' },
        { id: 'ejeVias', texto: '<div class="legend-item"><i style="background:#adadad"></i> Eje de vías</div>' },
        { id: 'predios', texto: '<div class="legend-item"><i style="background:#9a7051"></i> Predios SBN</div>' },
    ];
...
export function buscarCapaId(id) {
    return global.mapa.getLayers().getArray().find(layer => layer.get('id') === id) || null;
};
